  ...
  return (
    <aside className="hidden w-60 shrink-0 flex-col border-r bg-sidebar text-sidebar-foreground md:flex">
      <div className="flex h-14 items-center gap-2 border-b px-4">
        ...
        <span className="text-base font-semibold tracking-tight">Dental Canvas</span>
      </div>
      ...
      <div className="px-2 pt-3">
        ...
        >
          ...
          <kbd className="hidden rounded border bg-muted px-1.5 py-0.5 text-[10px] font-semibold lg:block">⌘K</kbd>
        </button>
      </div>
